...
public class day1 {
    ...
    public static void setTiArray() {
        ...
        Day_Activity.tiArray.add(new TI(
                "신체를 이용한 이용한 기억법을 배워봅시다. 방법은 간단합니다. 눈을 감고 머리속으로 상상만 하면 됩니다. 고고!",
                R.drawable.d2_1));
        Static.setBundle();
		...
		Day_Activity.tiArray.add(new TI(
                "머리부터 발까지 내려가며 각 신체부위에 준비물을 결합 할 것입니다.",
                R.drawable.d2_3));
        Static.setBundle();
        ...
        Day_Activity.tiArray.add(new TI(
                ...
                R.drawable.d2_11));
        Day_Activity.firstPageSound.put(Day_Activity.setArrayCount, R.raw.soil);
        Static.setBundle();
