...
public class day5_fc {
    public static void setTiArray() {
        ...
        Day_Activity.tiArray.add(new TI(
                "오늘은 기억의궁전에 관한 질문들에 답변해드릴께요. 마지막엔 꾸준히 해야 할 숙제도 있습니다.",
                R.drawable.d5_1));
        Static.setBundle();

        Day_Activity.tiArray.add(new TI(
                "A)하루에 20~30분 정도 꾸준히 연습하세요. 일단은 장소부터 확실하게 확보해야 합니다.\n저도 기억의 궁전을 만들기 위해서" +
        ...
        Day_Activity.tiArray.add(new TI(
                "두번째 질문이네요. 방을 쪼개는 방법이 있습니다. 다음 그림을 보며 이야기 합시다.",
                R.drawable.d5_4));
        Static.setBundle();
        ...
        Day_Activity.tiArray.add(new TI(
                "0~99까지 숫자를 자음화->인물로 변환(day4)해서 기억의 궁전으로 외우시면 됩니다." +
                        "(0~9, 00~99)\n" +
