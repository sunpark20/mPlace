...
public class day0_static {
    ...
    public static void setTiArray() {
       ...
       /* Day_Activity.tiArray.add(new TI(
        ...
        Day_Activity.tiArray.add(new TI(
                "'기억의 궁전'이라 불리는 기억법은 고대 유럽에서부터 시작됐습니다. 당시 종이에 기록하는 일은 값이 비싸고 많은 노력이 필요했습니다." +
                        " 덕분에 머리에 기억을 저장하는 기억술들이 비약적으로 발전 할 수 있었습니다.",
                R.drawable.d0_5));
        Static.setBundle();

        Day_Activity.tiArray.add(new TI(
                "인간의 뇌에는 장소를 관리하는 기관과 세포가 따로 있습니다. 그것을 이용한 기억법이 '기억의궁전'입니다." +
                        " 이는 짠 하면 외워지는 마법이나 기술이 아닙니다." +
                        " 운동으로 근육을 키우는 것처럼 기억의 궁전 또한 노력과 훈련이 필요합니다." +
                        " 하지만 선천적인 지능과 관계 없이, 기존 방식과는 비교도 안되게 기억을 극대화 시킬수 있는 도구입니다.",
                R.drawable.d0_2));
        Static.setBundle();
